...
| [`development/review-addendum.md`](development/review-addendum.md) | jerry's project-specific review rules, layered on top of the brine review protocol via `review_addendum` in `pickle.toml`; no overarching addendum, since jerry is the only child-project |
...
attention — is in [`development/review-addendum.md`](development/review-addendum.md), which deliberately does not
restate them.
